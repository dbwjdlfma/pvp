...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const patchNotesData = {
        "V1.9.4": `
        <p>V1.9.4.1<span class="update_date">(2025-10-16)</span></p>
                <hr>
                ...
                <div class="update_sub_container">
                킬할 시 버프가 적용이 안되던 버그 수정
                </div>
                </div>
                <br>
        <p>V1.9.4.1<span class="update_date">(2025-10-07)</span></p>
                <hr>
                <h5 class="update_cat">버그 수정</h5>
                <div class="update_container nojob">
                <div class="update_sub_container">
                하나에 직업에 여러명이 선택 하면 직업 선택이 취소 되게 변경됩니다</div>
                </div>
                <br>
        <p>V1.9.4<span class="update_date">(2025-10-13)</span></p>
                            <hr>
                            <h5 class="update_cat">직업</h5>
                            <div class="update_container">
                            <div class="update_sub_container">
        ...
        "V1.9.1": `<p>V1.9.1<span class="update_date">(2025-10-09)</span></p>
                ...
                <div class="update_container nojob">
                <div class="update_sub_container">
                한글날 기념으로 직업들의 이름이 순우리말로 바뀝니다<br>
                기간은 2025-10-09 ~ 2025-10-16 입니다<br><br>
                크리퍼 -> 펑퍼이<br>
                판사 -> 가름이<br>
                배터리 -> 힘그릇<br>
                암살자 -> 숨은 칼잽이<br>
        ...
        "V1.9.0": `<p>V1.9.0.2<span class="update_date">(2025-10-07)</span></p>
                ...
                <br>
                <p>V1.9.0<span class="update_date">(2025-10-04)</span></p>
                <hr>
                <h5 class="update_cat">직업</h5>
                <div class="update_container">
                <div class="update_sub_container">
